...
/**
 * LalgStatistics.Getsample API specification (optional)
 ...
 */
function _civicrm_api3_lalg_statistics_Getsample_spec(&$spec) {
  $spec['magicword']['api.required'] = 1;
}

/**
 * LalgStatistics.Getsample API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_lalg_statistics_Getsample($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'LalgStatistics', 'Getsample');
  }
  else {
