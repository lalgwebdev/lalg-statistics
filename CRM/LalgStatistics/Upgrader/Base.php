 ...
 */
class CRM_LalgStatistics_Upgrader_Base {

  /**
   * @var CRM_LalgStatistics_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_LalgStatistics_Upgrader(
        'lalg-statistics',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_LalgStatistics_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_LalgStatistics_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
